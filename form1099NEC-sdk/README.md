# TaxBandits Form1099NEC API SDK using JAVA
...
For requestingDraftPdfUrl of Form1099-NEC, pass the RecordId as request body along with Access Token in the header as
