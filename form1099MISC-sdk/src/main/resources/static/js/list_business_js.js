        ...
        success: function (response) {
            ...
            if(is200(code)) {
                ...
                $.each(businesses, function(index, business) {
                    var form1099MISCButtonId = "btnNavigateToCreateForm1099Misc" + index;
                    var listButtonId = "btnNavigateToForm1099MiscList" + index;
                    ...
                    rows += '<tr><td>' + business.businessId +'</td><td class="taL text-center flex-row justify-content-center">' + !isSsnTemp + '</td><td class="taL text-center flex-row justify-content-center">' + business.einorSSN + '</td><td class="taL">' + stringOrHyphen(businessOrFullName) + '</td><td class="taL" style="word-break: break-all">' + business.email + '</td><td class="text-center d-flex flex-row justify-content-center"><button class="btn btn-primary status-btn btn_smm me-2" id="' + form1099MISCButtonId + '"> Form1099MISC </button> <button class="btn btn-primary status-btn btn_smm me-2" id="' + listButtonId + '"> List </button></td></tr>';
                });
                ...
                $.each(businesses, function(index, business) {
                    var form1099MISCButtonId = "btnNavigateToCreateForm1099Misc" + index;
                    $("#" + form1099MISCButtonId).click(function () {
