# TaxBandits Form1099K API SDK using JAVA
...
For requestingDraftPdfUrl of Form1099-K, pass the RecordId as request body along with Access Token in the header as
